...
void laba7M::MyForm::InitializeComponent(void)
{
...
void laba7M::MyForm::button1_Click(System::Object^ sender, System::EventArgs^ e) 
{
	try {
		label2->Text = "";
		label3->Text = "";
...
void laba7M::MyForm::button2_Click(System::Object^ sender, System::EventArgs^ e) 
{
	try {
		int r, c;
		String^ input = textBox1->Text;
